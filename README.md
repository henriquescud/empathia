...
Os dados de cadastro e embeddings faciais são armazenados de forma segura no **MongoDB Atlas**.

### 🚀 Funcionalidades Principais
**- Cadastro de Funcionário**: Captura facial via webcam e registro dos dados do funcionário (**Nome, Cargo, Setor**) junto ao seu vetor facial (embedding) no **MongoDB**.
...
**- Ambiente de Produção**: Uso de **MongoDB Atlas** (nuvem) para persistência e **PyQT5** para a interface gráfica.
